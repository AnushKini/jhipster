...
public interface RoleRepository extends JpaRepository<Role, Long> {
    ...
    @Query(value = "select distinct role from Role role left join fetch role.appUsers",
    ...
    @Query("select role from Role role left join fetch role.appUsers where role.id =:id")
